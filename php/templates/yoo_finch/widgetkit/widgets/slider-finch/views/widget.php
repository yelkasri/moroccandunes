...
switch ($settings['link_style']) {
    case 'arrow':
        $link_style = 'tm-icon-arrow uk-link-reset';
        break;
    case 'button':
...
<div class="tm-slider-finch <?php echo $position_relative; ?> <?php echo $settings['class']; ?>" data-uk-slider="<?php echo $options; ?>">
        ...
        <?php foreach ($items as $item) :
                ...
                if ($item->type('media') == 'image' && $settings['media']) {
                    if ($settings['image_width'] != 'auto' || $settings['image_height'] != 'auto') {
                        ...
                        $media = 'background-image: url(' . $item['media'] . ');';
                    }
                } else {
                    $media = '';
                }
                ...
                $min_height = 'height: ' . $settings['min_height'] . 'px;';
            ...
            <li>
                ...
                <div class="uk-panel uk-panel-box uk-text-<?php echo $settings['text_align']; ?>">
                    <h3 class="<?php echo $title_size; ?> uk-margin-remove">
                ...
                <div class="uk-panel uk-overlay uk-overlay-hover uk-cover-background uk-margin-top-remove" <?php echo $media; ?>>
    ...
    <?php elseif ($settings['slidenav'] == 'bottom-center') : ?>
