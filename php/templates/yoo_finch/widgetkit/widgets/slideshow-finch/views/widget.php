...
switch ($settings['overlay']) {
    case 'center':
        ...
        break;
    case 'middle-left':
        $overlay .= ' uk-flex uk-flex-middle uk-width-4-5 uk-container-center';
        break;
    default:
        ...
        <?php foreach ($items as $item) :
            ...
            <li style="min-height: <?php echo $settings['min_height']; ?>px;">
                ...
                <?php if ($item['media'] && $settings['media']) : ?>
                    ...
                    <?php if ($settings['overlay'] != 'none' && (($item['title'] && $settings['title']) || ($item['content'] && $settings['content']) || ($item['link'] && $settings['link']) || ($settings['nav_overlay'] && $settings['nav'] != 'none'))) : ?>
                    <div class="<?php echo $overlay; ?>">
                        ...
                        <div class="uk-align-center <?php echo $content_size; ?> uk-margin"><?php echo $item['content']; ?></div>
                        <?php endif; ?>
